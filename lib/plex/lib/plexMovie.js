...
async function plexMovie(res, tautulli, next) {
    ...
    if (data.tmdb.usingTmdb == true) {
        ...
        if (tmdbSuccess == true) {
            ...
            if (tmdbMovie.production_countries[0].iso_3166_1 != '' && tmdbMovie.production_countries[0].iso_3166_1 != 'US' && tmdbMovie.production_countries[0].iso_3166_1 != 'GB') {
                data.images.flag = await downloadFlag.downloadFlag(tmdbMovie.production_countries[0].iso_3166_1);
                data.region = tmdbMovie.production_countries[0].iso_3166_1;
            }
