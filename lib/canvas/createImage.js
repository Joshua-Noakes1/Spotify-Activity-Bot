...
async function main(data) {
    ...
    canvasTxt.drawText(ctx, `${data.data.title}`, 938, 405, 1160, 80);

    canvasTxt.font = 'NotoSansMed, NotoSansJPMed';
    canvasTxt.fontSize = '43';
    canvasTxt.drawText(ctx, `${data.data.artist}`, 941, 478, 1160, 80);
...
(async () => {
    let spotifyInfo
    try {
        spotifyInfo = await getPreview('https://open.spotify.com/track/41THWUMaj9vZhJuHxbHyhl?si=ee378469e3564a50', {
            headers: {
